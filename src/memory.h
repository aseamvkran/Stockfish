...
// ponytail: the AlignedPtr/make_unique_aligned twins of the large-page helpers above had no
// callers; std_aligned_alloc/free are used directly. Re-add from git history if ever needed.
